import{a as e}from"./instance-CQn6uUsC.js";import{Gt as t}from"./handleFs-DGI7WMkN.js";function n(e){return`COALESCE(LOWER(${e}.content_ref), '') NOT LIKE '%.base'`}function r(e=`t`){return`(
    ${n(e)}
    AND (

import{a as e}from"./instance-BfmhJNRy.js";import{ar as t}from"./src-locvV_of.js";function n(e){return`COALESCE(LOWER(${e}.content_ref), '') NOT LIKE '%.base'`}function r(e=`t`){return`(
    ${n(e)}
    AND (
